...
/**
 * Days to Milliseconds converter test.
 * @author Zoey76
 * @version 2.6.3.0
 */
class Days2MillisecondsConverterTest {
	
	private static final Days2MillisecondsConverter CONVERTER = new Days2MillisecondsConverter();
	...
	private static Stream<Object[]> provideValidInputs() {
		// @formatter:off
        return Stream.of(
            new Object[]{"2", 172800000L},   // 2 days to milliseconds
            new Object[]{"0", 0L},           // 0 days
            new Object[]{"-1", -86400000L},  // Negative day
